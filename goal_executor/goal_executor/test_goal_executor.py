...
def main():
    ...
    while rclpy.ok():
        ...
        goal_pose.pose.position.x = 0.2973061525018091
        goal_pose.pose.position.y = 1.2554090299273197
        goal_pose.pose.position.z = 0.0  # Assuming 2D navigation, z is set to 0.0

        goal_pose.pose.orientation.x = 0.0
        goal_pose.pose.orientation.y = 0.0
        goal_pose.pose.orientation.z = 0.6383077829212951
        goal_pose.pose.orientation.w = 0.7697812509161943
